...
### Fixed
- `--version` now reads from package.json (was hardcoded to 0.1.1 in v0.3.0 release binaries)
- Version is now single-sourced from package.json across CLI output and self-updater
...
[0.3.1]: https://github.com/Danielkweber/slackcli/releases/tag/v0.3.1
